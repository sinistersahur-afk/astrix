...
update: all
	ssh $(DEVICE) "rm -rf /var/mobile/Documents/Astrix.tipa /var/mobile/Documents/Dopamine.tipa"
	scp -C ./Application/Astrix.tipa "$(DEVICE):/var/mobile/Documents/Astrix.tipa"
	ssh $(DEVICE) "/var/jb/basebin/jbctl update tipa /var/mobile/Documents/Astrix.tipa"
