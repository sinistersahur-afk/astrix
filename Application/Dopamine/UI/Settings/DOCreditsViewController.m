...
- (id)specifiers
{
    if(_specifiers == nil) {
        ...
        [headerSpecifier setProperty:[NSString stringWithFormat:@"Astrix %@ - %@", [DOEnvironmentManager sharedManager].appVersionDisplayString, DOLocalizedString(@"Menu_Credits_Title")] forKey:@"title"];
    }
    return _specifiers;
}
